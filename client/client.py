...
#        print "Timeout set to 5"
    ...
    def recvData(self):
        ...
        try:
            ...
            sys.stderr.write(
                "[SOCKET PIPE ERROR WHILE RECEIVING] %s\n.Possible reason: socket closed due to time out and/or requested server is currently busy" % str(msg))
            raise
    ...
    def sendData(self, data):
        ...
        try:
            ...
            sys.stderr.write(
                "[SOCKET PIPE ERROR WHILE SENDING] %s\n" % str(msg))
            raise
